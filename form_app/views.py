...
def index(request):
    ...
    return render(request, "form_app/index.html", context= context_dict)
...
def register(request):
    ...
    return render(request, 'form_app/register.html', {'user_form': user_form,
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                login(request,user)
                return HttpResponseRedirect(reverse('form_app:index'))
